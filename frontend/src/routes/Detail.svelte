        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-light text-dark p-2 text-start mx-3">
                    ...
                    <div>{moment(question.modify_date).format("YYYY-MM-DD hh:mm a")}</div>
                </div>
                {/if}
                <div class="badge bg-light text-dark p-2 text-start">                    
                    <div class="mb-2">{ question.user ? question.user.username : ""}</div>
                    <div>{moment(question.create_date).format("YYYY-MM-DD hh:mm a")}</div>
                </div>
            </div>
            <div class="my-3">
    ...
    <div class="card my-3">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="badge bg-light text-dark p-2 text-start mx-3">
                    <div class="mb-2">modified at</div>
                    <div>{moment(answer.modify_date).format("YYYY-MM-DD hh:mm a")}</div>
                </div>
                {/if}
                <div class="badge bg-light text-dark p-2 text-start">
